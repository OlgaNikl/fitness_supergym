...
},{"./modules/form-validate/form":3,"./modules/smooth-scroll/init-smooth-scroll":9,"./modules/swiper/init-swiper":10,"./modules/tabs/init-tabs":11,"./modules/video/video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperTeam = exports.initSwiperReviews = void 0;
var swiperTeam = document.querySelector('.coaches__slider');
  ...
  if (swiperTeam) {
    (function () {
      return new Swiper('.coaches__slider', {
        ...
        on: {
          inint: function inint() {
            var duplicateSlides = swiperTeam.document.querySelectorAll('swiper-slide-duplicate');
            duplicateSlides.forEach(function (item) {
...
exports.initSwiperTeam = initSwiperTeam;
var swiperReviews = document.querySelector('.reviews__slider');
...
var initPlayVideo = function initPlayVideo() {
  ...
  playButton.addEventListener('click', function () {
    if (video && videoIframe) {
      playButton.remove();
      link.remove();
      var newIframe = createIframe(videoIframe);
      videoIframe.append(newIframe);
    }
  });
};
exports.initPlayVideo = initPlayVideo;
